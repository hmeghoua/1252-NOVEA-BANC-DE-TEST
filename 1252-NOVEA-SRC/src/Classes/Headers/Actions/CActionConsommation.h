 ...
 *
 */
#ifndef CLASSES_HEADERS_ACTIONS_CACTIONCONSOMMATION_H_
#define CLASSES_HEADERS_ACTIONS_CACTIONCONSOMMATION_H_

#include <CAction.h>
#include "../Global.h"

class CActionConsommation: public CAction {
public:
	CActionConsommation();
...
#endif /* CLASSES_HEADERS_ACTIONS_CACTIONCONSOMMATION_H_ */
