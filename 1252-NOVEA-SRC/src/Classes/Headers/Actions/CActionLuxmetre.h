 ...
 *
 */
#ifndef CLASSES_HEADERS_ACTIONS_CACTIONLUXMETRE_H_
#define CLASSES_HEADERS_ACTIONS_CACTIONLUXMETRE_H_
...
class CActionLuxmetre: public CAction {
public:
	CActionLuxmetre();
	virtual ~CActionLuxmetre();
	uint pingI2CLuxmetre();
	uint calibrationLuxmetre();
...
#endif /* CLASSES_HEADERS_ACTIONS_CACTIONLUXMETRE_H_ */
