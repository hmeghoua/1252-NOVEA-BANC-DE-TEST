 ...
 *
 */
#ifndef CSTATELEDRGB_H_
#define CSTATELEDRGB_H_

//#include "../../Pattern/Headers/CStateBanc.h"
#include <CStateBanc.h>
#include "../Transitions/EvtTransitionSLedRGBVersSLuxmetre.h"

class CAction;

class CStateLedRGB: public CStateBanc {
public:

	CStateLedRGB();
	virtual ~CStateLedRGB();
...
#ifdef DEBUG_PC
    	cout<<"****************************************************************"<<endl;
    	cout << "Entree Etat StateLedRGB:"<<endl;
#endif
    	return "ok";
    }
...
#ifdef DEBUG_PC
      	cout << "Sortie Etat StateLedRGB"<<endl;
#endif
      	return "ok";
   }
