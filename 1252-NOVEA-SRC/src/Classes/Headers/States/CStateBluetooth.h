 ...
 *
 */
#ifndef CSTATEBLUETOOTH_H_
#define CSTATEBLUETOOTH_H_
...
class CStateBluetooth: public CStateBanc {
public:

	CStateBluetooth();
	virtual ~CStateBluetooth();
...
#ifdef DEBUG_PC
    	cout<<"****************************************************************"<<endl;
    	cout << "Entree Etat StateBluetooth"<<endl;
#endif
    	return "ok";
    }
...
#ifdef DEBUG_PC
      	cout << "Sortie Etat StateBluetooth"<<endl;
#endif
      	return "ok";
   }
